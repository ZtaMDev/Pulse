...
- Updated [Guards Guide](/core/guards) with composition and type helpers
- Updated [Logic Composition](/advanced/composition) with `guard.map`
- Refreshed [API Reference](/reference/api)
